...
// Mac OS X 10.9 SDK. Copied so we are not dependant on
// Carbon.framework. Since these constants date back to the
// Inside Mac era, they are unlikely to change any time soon.
// ------------------------------------------------------------------
